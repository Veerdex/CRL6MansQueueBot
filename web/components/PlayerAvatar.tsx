...
// Top Players, Season/All-Time stats). Sized in `em` (2.2x the surrounding font-size — originally
// 1.1x, doubled per direct request) rather than a fixed pixel value, so it stays proportional to
// whatever text size it sits next to instead of needing a different size prop per call site.
